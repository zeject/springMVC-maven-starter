...
public class UpYun {
	 ...
	 */
	public UpYun() {
		this.bucketName = Constants.upyunName;
		this.userName = Constants.upyunUserName;
		this.password = md5(Constants.upyunPassword);
	}
	...
	public boolean writeFile(String filePath, File file, boolean auto) throws IOException {
		this.setContentMD5(UpYun.md5(file));

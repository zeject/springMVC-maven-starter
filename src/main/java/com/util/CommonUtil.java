...
public class CommonUtil {
    ...
    public static String getUrlShort(String longUrl) {
        ...
        try {
            ...
            JSONObject obj = JSONObject.parseObject(doc.toString());
            JSONArray o = obj.getJSONArray("urls");
            JSONObject a = o.getJSONObject(0);
    ...
    public static void ajaxresponse(HttpServletResponse response, Map responseMap) {
        ...
        try {
            ...
            if (out != null) {
                out.print(JSON.toJSON(responseMap));
                out.flush();
                out.close();
            }
        }
        ...
        try {
            ...
            if (out != null) {
                ...
                if (obj instanceof String) {
                    ...
                    out.print("data:" + JSON.toJSON(obj) + "\n\n");
                } else {
                    out.print("data:" + obj + "\n\n");
                }
                out.flush();
     ...
     *
     * @param realPath    绝对路径
     * @param fileSizeMax 上传文件大小 byte
     * @param zz          正则(jpg|png|jpeg|gif|bmp)
     * @param request
     * @param upyun       是否上传到upyun true or false
     * @return 已上传图片名字
     */
